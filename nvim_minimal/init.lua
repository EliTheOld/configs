...
-- WARN: Show which line your cursor is on
...
require("lazy").setup({
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>sM", builtin.man_pages, { desc = "[S]earch [M]anual" })
	...
	{ -- LSP Configuration & Plugins
		...
		config = function()
			...
			vim.list_extend(ensure_installed, {
				"stylua", -- You can add other tools here that you want Mason to install
				"prettierd", -- for you, so that they are available from within Neovim.
			})
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>f", ":lua MiniFiles.open()<CR>", { desc = "[F]iles" })
	...
	{ -- Highlight, edit, and navigate code
		...
		build = ":TSUpdate",
		opts = {
			ensure_installed = { "bash", "c", "diff", "html", "hyprlang", "lua", "luadoc", "markdown", "vim", "vimdoc" },
